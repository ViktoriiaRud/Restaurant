...
import { WrapperLogo, Logo, WrapperBanner, Span, WrapperWelcome, WrapperTitle, WrapperImg, StyledWrapperColorHeader, } from "./HeaderRestaurantStyles";
